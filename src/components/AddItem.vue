<template>
  <div class="mt-[55px]">
    <form @submit.prevent="" class="max-w-md mx-auto">
      ...
      <div class="mb-4">
        <label for="ingredients" class="block text-gray-700"
          >Ингредиенттер:</label
        >
        <input
          type="text"
      ...
      <div class="mb-4">
        <label for="weight" class="block text-gray-700">Салмақ:</label>
        <input
          type="number"
          id="weight"
          v-model="itemsPizza.weight"
          class="w-full border border-gray-300 rounded-md px-3 py-2 mt-1 focus:outline-none focus:border-indigo-500"
        />
      </div>
      <div class="mb-4">
        <label for="width" class="block text-gray-700">Өлшемі:</label>
        <input
          type="number"
          id="width"
          v-model="itemsPizza.width"
          class="w-full border border-gray-300 rounded-md px-3 py-2 mt-1 focus:outline-none focus:border-indigo-500"
        />
      </div>
      <div
